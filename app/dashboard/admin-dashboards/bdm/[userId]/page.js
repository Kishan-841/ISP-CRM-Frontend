    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4 mt-3 md:mt-4">
        {[
          ...
          // OTC family: total + per-stage breakdowns. Each card scopes
          // the pipeline-arc drill-down to this same BDM via userId.
          ...
          { label: 'Login OTC', value: formatCurrency(dashStats.loginOtcAmount), icon: DollarSign, borderColor: 'border-l-cyan-500', iconBg: 'bg-cyan-100 dark:bg-cyan-900/40', iconText: 'text-cyan-600 dark:text-cyan-400', stage: 'login-otc' },
          { label: 'PO Received OTC', value: formatCurrency(dashStats.poReceivedOtcAmount), icon: DollarSign, borderColor: 'border-l-emerald-500', iconBg: 'bg-emerald-100 dark:bg-emerald-900/40', iconText: 'text-emerald-600 dark:text-emerald-400', stage: 'po-otc' },
        ].map((stat, i) => (
          <Card
            key={i}
